	...
	//var provincia_id = 112;
	var base = $('base').attr('href');
	var url  = base+'Provincias/geojson?departamento_id='+departamento_id;
	var url2 = base+'Distritos/delitosgeojson?departamento_id=' + departamento_id;
	var url3 = base+'Distritos/institucionesgeojson?departamento_id=' + departamento_id;
	...
	*/
	...
	var vectorLayer = new ol.layer.Vector({
		...
		style : function(feature) {
			style.getText().setText(feature.get('nombprov'));
			return style;
		}
	});
	/*******Dibuja el perimetro ********/
	...
	$.ajax({
		url: base+'Departamentos/geojson?departamento_id='+departamento_id,
	    dataType: 'json',
	    async: false,
	    method: 'get',
...
var map = new ol.Map({
	...
	var featureOverlay = new ol.layer.Vector({
		...
		map : map,
		style : function(feature) {
			highlightStyle.getText().setText(feature.get('nombprov'));
	...
	var displayFeatureInfo = function(pixel) {
		...
		if (feature) {
			...
			info.innerHTML = 'Departamento: '+ feature.get('nombprov') + ' Area: '+ feature.get('ha');
		} else {
			//info.innerHTML = '&nbsp;';
		}
