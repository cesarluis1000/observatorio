...
<fieldset class="mapfieldset">
	...
	<div class="maprow">
		...
		<div class="contenedor--menu">
					...
					<article class="skills">
						...
						<div class="form-check-all">
							<p>
								...
								<span></span>
								<span></span><span class="skills"></span>
							</p>
			...
			<fieldset>
				<legend class="legend">Leyenda</legend>
				<p>
					<label>Hospital</label>
					<img alt="" src="app\webroot\img\map\Hospital60px.png" style="width: 20px">
				</p>
				<p>
					<label>Comisaria</label>
					<img alt="" src="app\webroot\img\map\Policia60px.png" style="width: 20px">
				</p>
				<style>
					li.list-group-item.bajo {
						background-color: #7cf77a;
					}

					li.list-group-item.medio {
						background-color: #f4f339;
					}

					li.list-group-item.alto {
						background-color: #fe490e;
					}

					li.list-group-item.muy_alto {
						background-color: #ff1203;
					}
				</style>
				<legend class="legend">Nivel de delito</legend>
				<ul class="list-group">
					<li class="list-group-item bajo">BAJO</li>
					<li class="list-group-item medio">MEDIO</li>
					<li class="list-group-item alto">ALTO</li>
					<li class="list-group-item muy_alto">MUY ALTO</li>
				</ul>
			</fieldset>
