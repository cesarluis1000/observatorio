...
<fieldset>
    ...
    <div class="row">
    	...
    	<div class="col-md-2">
    				 <legend><?php echo __('Mapa de Presos'); ?></legend>
                     <?php
            	...
            	<label for="track">
                  Buscar Ubicaci�n
                  <input id="chkGeolocalizacion" type="checkbox"/>
                </label>
                <br/>
            	
            	<select id="cmbAgregarPunto" class="form-control input-xs">
            		<option value="None">None</option>
                    <option value="Point">Ingresar punto</option>
                </select>
                 -->
