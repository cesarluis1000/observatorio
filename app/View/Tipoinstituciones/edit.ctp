<fieldset>
	<legend><?php echo __('Edit Tipoinstitucion'); ?></legend>
	<?php echo $this->Form->create('Tipoinstitucion', array('class' => 'form-horizontal',
		...
		echo $this->Form->input('institucion',array('label'=>array('class'=>'control-label col-sm-2')));
