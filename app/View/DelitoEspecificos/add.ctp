<fieldset>
	<legend><?php echo __('Registrar Delito Especifico'); ?></legend>
	<?php echo $this->Form->create('DelitoEspecifico', array('class' => 'form-horizontal',
		...
		echo $this->Form->input('delito_generico_id',array('label'=>array('class'=>'control-label col-sm-2')));
	?>
